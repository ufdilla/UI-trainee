                            ...
                            <td>
                                ...
                                foreach ($refine_array as $value) 
                                {
                                    for($a=0; $a < count($value); $a++)
                                    {
                                        ...
                                        print "<td>".$value[$a]['userId']."</td>";
                                        print "<td>".$value[$a]['password']."</td>";
                                        print "<td>".$value[$a]['address']."</td>";
                                        print "<td>".$value[$a]['positionId']."</td>";
                                        print "<td>".$value[$a]['groupId']."</td>";
                                        print "<td>".$value[$a]['status']."</td>";
                                        print "<td>".$value[$a]['phone']."</td>";
                                        print "<td>".$value[$a]['email']."</td>";
                                        print "</tr>";
                                    }
                                        }
                                ?>
